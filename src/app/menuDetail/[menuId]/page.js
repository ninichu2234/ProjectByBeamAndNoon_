                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                    ...
                    <div className="p-6 sm:p-8">
                        ...
                        <p className="text-3xl font-bold text-amber-600 mb-8">
                            ราคารวม: {currentPrice.toFixed(2)} ฿
                        </p>
                        ...
                        <button
                            ...
                            className="w-full bg-green-700 hover:bg-green-800 text-white font-bold py-3 px-8 rounded-lg transition-colors duration-300 shadow-md hover:shadow-lg text-lg flex items-center justify-center gap-2 disabled:bg-gray-400 disabled:cursor-not-allowed"
                        >
